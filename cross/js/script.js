...
(function ($) {
	$(function () {
		...
		var puzzleData = [{
				clue: "Primera letra del alfabeto griego",
				answer: "alpha",
				position: 1,
				orientation: "across",
				startx: 1,
			...
			{
				clue: "es algo muy importante para vivir",
				answer: "aire",
				position: 5,
				orientation: "across",
				startx: 1,
			...
			{
				clue: "Zombie ipsum reversus ab viral inferno, nam rick grimes malum cerebro. De carne lumbering animata corpora quaeritis. Summus brains sit​​, morbo vel maleficia?",
				answer: "erebros",
				position: 8,
				orientation: "across",
				startx: 1,
